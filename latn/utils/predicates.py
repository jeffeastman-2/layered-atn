...
def is_expletive(tok): return tok is not None and tok.isa("expletive")
def is_wh(tok): return tok is not None and tok.isa("wh")
def is_first_person(tok): return tok is not None and tok.isa("first_person")
